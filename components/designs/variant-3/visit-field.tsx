    ...
    <section id="visit" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-12">
          ...
          <div>
            <h3 className="text-2xl font-bold text-[#2D2A3E] mb-6">{visit.heading}</h3>
        ...
        <div className="relative overflow-hidden rounded-3xl">
          <div className="aspect-[21/9] md:aspect-[21/7]">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-[#6B4C9A]/90 via-[#6B4C9A]/70 to-transparent" />
